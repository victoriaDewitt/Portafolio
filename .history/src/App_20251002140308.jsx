...
function App() {
  ...
  return (
    <div className="font-sans bg-black text-gray-100 relative">
      ...
      {/* Navbar */}
      <header className="relative max-w-5xl w-full bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-800/70 rounded-2xl p-8 shadow-lg flex flex-col md:flex-row justify-center items-center gap-12 z-10">
