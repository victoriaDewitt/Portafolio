...
<motion.div
  className="w-48 h-48 flex justify-center items-center overflow-hidden"
  animate={{ y: [0, -20, 0] }} // efecto flotado más visible
  transition={{
    duration: 6,
    repeat: Infinity,
    ease: "easeInOut",
  ...
  whileHover={{
    rotateY: 360, // rotación 3D sobre el eje Y
    transition: {
      duration: 2,
      repeat: Infinity,
      ease: "linear",
  ...
  onHoverEnd={(e) => {
    ...
    e.target.style.transition = "transform 1s ease-out";
  }}
  style={{ perspective: 1000 }} // para que se note la rotación 3D
>
  <img
    src="/icons/atomo.png"
