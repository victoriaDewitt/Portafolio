...
<section id="education" className="max-w-5xl mx-auto py-20 px-6">
  <h2 className="text-3xl font-bold text-indigo-400 mb-10 text-center">Education</h2>
  <div className="flex flex-col items-center gap-12">
    <motion.div
      className="flex flex-col md:flex-row items-center gap-6 bg-gray-800 rounded-2xl p-6 shadow-lg w-full"
      initial={{ opacity: 0, y: 50 }}
    ...
    >
      <img
        src="/icons/udvm.png" // aquí va tu logo de la universidad
        alt="Universidad Del Valle de México"
        className="w-32 h-32 object-contain rounded-lg"
      />
      <div>
        <h3 className="text-xl font-bold text-indigo-300">Universidad Del Valle de México</h3>
        <p className="text-gray-300 mt-2">Bachelor’s Degree in Software Engineering (2021 - 2025)</p>
      </div>
    </motion.div>
  </div>
</section>
