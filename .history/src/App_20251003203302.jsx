  ...
  return (
    <div className="font-sans bg-black text-gray-100 relative">
      ...
      <section id="education" className="relative flex flex-col items-center justify-center px-6 py-16 text-white">
        ...
        <div className="max-w-4xl w-full flex flex-col gap-6">
          {t.education.items.map((edu, i) => (
            <div key={i} className="bg-gray-900 rounded-xl p-4 shadow-lg hover:shadow-xl transition">
      ...
      <section id="contact" className="relative flex flex-col items-center justify-center px-6 py-16 text-white">
        ...
        <form className="max-w-2xl w-full flex flex-col gap-4">
          <input type="text" placeholder={t.contact.name} className="p-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-indigo-400" />
          <input type="email" placeholder={t.contact.email} className="p-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-indigo-400" />
          <textarea placeholder={t.contact.message} rows="5" className="p-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-indigo-400"></textarea>
          <button type="submit" className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl font-semibold transition">{t.contact.send}</button>
        </form>
      </section>
