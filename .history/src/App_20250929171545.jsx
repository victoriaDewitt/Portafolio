...
function App() {
  ...
  return (
    <div className="font-sans bg-white text-gray-900 dark:bg-black dark:text-gray-100">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            {/* Card 1 */}
            <div className="flex items-center bg-gradient-to-r from-indigo-700 to-indigo-900 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
            ...
            {/* Card 2 */}
            <div className="flex items-center bg-gradient-to-r from-pink-600 to-pink-800 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
            ...
            {/* Card 3 */}
            <div className="flex items-center bg-gradient-to-r from-green-600 to-green-800 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
      ...
      <section
        id="contact"
        className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white dark:from-blue-700 dark:to-purple-900 py-20 px-6"
      >
