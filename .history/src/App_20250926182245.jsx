...
<section id="projects" className="bg-gradient-to-b from-gray-900 to-gray-800 py-20 px-6 text-white">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      {/* Card 1 */}
      <div className="bg-gradient-to-b from-indigo-700 to-indigo-900 rounded-2xl shadow-xl p-6 flex flex-col items-center hover:scale-105 transition-transform">
        <img
          src="https://placehold.co/300x200/6366F1/fff?text=Project+1"
          alt="Project 1"
      ...
      {/* Card 2 */}
      <div className="bg-gradient-to-b from-pink-600 to-pink-800 rounded-2xl shadow-xl p-6 flex flex-col items-center hover:scale-105 transition-transform">
        <img
          src="https://placehold.co/300x200/EC4899/fff?text=Project+2"
          alt="Project 2"
          className="rounded-xl mb-6"
        />
      ...
      {/* Card 3 */}
      <div className="bg-gradient-to-b from-green-600 to-green-800 rounded-2xl shadow-xl p-6 flex flex-col items-center hover:scale-105 transition-transform">
        <img
          src="https://placehold.co/300x200/10B981/fff?text=Project+3"
          alt="Project 3"
          className="rounded-xl mb-6"
        />
