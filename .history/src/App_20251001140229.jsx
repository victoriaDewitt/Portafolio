...
<section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden bg-black">
  ...
  <div className="absolute inset-0 -z-10">
    <div className="absolute w-[150%] h-[150%] bg-purple-700/40 rounded-full blur-[200px] animate-nebulaMove"></div>
    <div className="absolute w-[120%] h-[120%] bg-pink-600/30 rounded-full blur-[150px] animate-nebulaMove2"></div>
    <div className="absolute w-[130%] h-[130%] bg-blue-800/20 rounded-full blur-[180px] animate-nebulaMove3"></div>
  </div>
  ...
  <style jsx>{`
    ...
    .animate-nebulaMove2 {
      animation: nebulaMove2 35s ease-in-out infinite alternate;
    }

    .animate-nebulaMove3 {
      animation: nebulaMove3 40s ease-in-out infinite alternate;
    }
  `}</style>
</section>
