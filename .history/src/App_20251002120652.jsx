  ...
  <div className="p-4 flex flex-col justify-between">
    ...
    <div className="mt-2 flex gap-2">
      <a href="https://github.com/victoriaDewitt/eccomerce-tcg.git" target="_blank" rel="noopener noreferrer">
        <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">Explore</button>
      </a>
      <a href="https://github.com/victoriadewitt/eccomerce-tcg-demo" target="_blank" rel="noopener noreferrer">
        <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">Demo</button>
      </a>
    </div>
  </div>
</div>
