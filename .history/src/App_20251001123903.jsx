...
<section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden">
  ...
  <div className="absolute inset-0 -z-10" 
       style={{ 
         background: 'radial-gradient(circle at 20% 30%, #ff70a6 0%, transparent 40%), radial-gradient(circle at 80% 70%, #845ec2 0%, transparent 50%), radial-gradient(circle at 50% 50%, #0081cf 0%, transparent 60%), #0b0b1d',
