...
<div className="relative w-full py-12 z-10 bg-black/10 overflow-hidden">
  <div className="flex space-x-12 max-w-6xl mx-auto animate-marquee">
    {skillIcons.concat(skillIcons).map((skill, index) => (
      <div key={index} className="relative flex flex-col items-center group">
        {/* Tooltip */}
        <span
          className="absolute -top-10 px-3 py-1 rounded text-sm font-semibold text-cyan-400 opacity-0 group-hover:opacity-100 select-none"
          style={{
        ...
        <img
          src={skill.icon}
          alt={skill.name}
          className="h-32 w-32 md:h-36 md:w-36 object-contain transition-transform duration-300 group-hover:-translate-y-5"
        />
      </div>
    ))}
  </div>
