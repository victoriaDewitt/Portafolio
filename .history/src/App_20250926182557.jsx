...
<section id="projects" className="bg-gradient-to-b from-gray-900 to-gray-800 py-20 px-6 text-white">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      {/* Card 1 */}
      <div className="bg-gradient-to-b from-indigo-700 to-indigo-900 rounded-2xl shadow-xl flex flex-col justify-between h-[420px] p-6 hover:scale-105 transition-transform">
        <div>
        ...
        <button className="mt-6 bg-orange-500 hover:bg-orange-600 px-6 py-2 rounded-lg font-semibold">
          Explore
        </button>
      </div>

      {/* Card 2 */}
      <div className="bg-gradient-to-b from-pink-600 to-pink-800 rounded-2xl shadow-xl flex flex-col justify-between h-[420px] p-6 hover:scale-105 transition-transform">
        <div>
      ...
      {/* Card 3 */}
      <div className="bg-gradient-to-b from-green-600 to-green-800 rounded-2xl shadow-xl flex flex-col justify-between h-[420px] p-6 hover:scale-105 transition-transform">
        <div>
