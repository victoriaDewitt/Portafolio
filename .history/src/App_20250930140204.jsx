...
function App() {
  ...
  return (
    <div className="font-sans bg-white text-gray-900 dark:bg-black dark:text-gray-100">
      ...
      <section
        id="projects"
        className="bg-gradient-to-b from-gray-900 to-gray-800 dark:from-gray-800 dark:to-gray-900 py-20 px-6 text-white"
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            {/* Card 1 */}
            <div className="flex items-center bg-gradient-to-r from-indigo-700 to-indigo-900 dark:from-indigo-900 dark:to-indigo-700 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-200 text-sm">React + Tailwind</p>
                </div>
            ...
            {/* Card 2 */}
            <div className="flex items-center bg-gradient-to-r from-pink-600 to-pink-800 dark:from-purple-700 dark:to-pink-900 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-200 text-sm">Java + MySQL</p>
                </div>
                <button className="mt-2 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">
                  Explore
                </button>
            ...
            {/* Card 3 */}
            <div className="flex items-center bg-gradient-to-r from-green-600 to-green-800 dark:from-green-900 dark:to-green-700 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
      ...
      <section
        id="contact"
        className="bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-blue-700 dark:to-purple-900 text-white py-20 px-6"
      >
