...
{/* Estrellas fugaces más realistas */}
{[...Array(8)].map((_, i) => {
  const startX = Math.random() * 100;
  const startY = Math.random() * 60;
  const duration = Math.random() * 1.5 + 0.8; // más rápidas
...
<section
  id="about"
  className="relative min-h-screen flex items-center justify-center px-6 py-16 overflow-hidden text-white"
>
  {/* Fondo nebuloso */}
  <div className="absolute inset-0 -z-20">
    <div
      className="absolute w-[220%] h-[220%] rounded-full blur-[250px] animate-nebulaMove"
      style={{ background: 'radial-gradient(circle at 30% 40%, #0b1c2c, transparent 70%)', opacity: 0.4, mixBlendMode: 'screen' }}
    />
    <div
      className="absolute w-[200%] h-[200%] rounded-full blur-[200px] animate-nebulaMove2"
      style={{ background: 'radial-gradient(circle at 70% 50%, #10213a, transparent 70%)', opacity: 0.35, mixBlendMode: 'screen' }}
    />
    <div
      className="absolute w-[240%] h-[240%] rounded-full blur-[220px] animate-nebulaMove3"
  ...
  <div className="relative max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center z-10">
    ...
    >
      <h2 className="text-3xl md:text-4xl font-bold text-indigo-400 mb-6">About Me</h2>
    ...
    >
      <img 
        ...
        alt="Victoria Vázquez"
        className="rounded-full shadow-lg w-48 h-48 md:w-64 md:h-64 object-cover border-4 border-white/20"
      />
    </motion.div>
  </div>
</section>
...
>
  {/* Fondo nebuloso animado */}
  <motion.div className="absolute inset-0 -z-20">
    <motion.div
      className="absolute w-[220%] h-[220%] rounded-full blur-[250px]"
      style={{
        background: 'radial-gradient(circle at 30% 40%, #0b1c2c, transparent 70%)',
        opacity: 0.4,
        mixBlendMode: 'screen',
      }}
    ...
    />
    <motion.div
      className="absolute w-[200%] h-[200%] rounded-full blur-[200px]"
      style={{
        background: 'radial-gradient(circle at 70% 50%, #10213a, transparent 70%)',
        opacity: 0.35,
        mixBlendMode: 'screen',
      }}
    ...
    />
    <motion.div
      className="absolute w-[240%] h-[240%] rounded-full blur-[220px]"
      style={{
        background: 'radial-gradient(circle at 50% 70%, #18304d, transparent 70%)',
        opacity: 0.3,
        mixBlendMode: 'screen',
      }}
  ...
  <div className="relative max-w-5xl w-full bg-black/80 rounded-2xl p-10 shadow-lg flex flex-col md:flex-row justify-center items-center gap-16 z-10">
...
>
  ...
  <div className="relative max-w-6xl w-full mt-10">
    <h2 className="text-3xl md:text-4xl font-bold text-center text-indigo-400 mb-12">Projects 🚀</h2>
...
{/* Banda de Skills */}
<div className="relative w-full py-16 z-10 bg-black/10 overflow-hidden">
  <div className="flex animate-marquee space-x-12 justify-center">
    {skillIcons.concat(skillIcons).map((skill, index) => (
      <div key={index} className="relative flex flex-col items-center group min-w-[100px]">
        {/* Tooltip */}
        <span
          className="absolute -top-10 px-2 py-1 rounded text-lg font-bold text-cyan-400 opacity-0 group-hover:opacity-100 select-none"
          style={{
            textShadow: '0 0 3px #0ff, 0 0 6px #0ff, 0 0 9px #0ff',
        ...
        <img
          src={skill.icon}
          alt={skill.name}
          className="h-32 w-32 md:h-40 md:w-40 object-contain transition-transform duration-300 group-hover:-translate-y-6"
        />
      </div>
    ))}
  </div>
...
<section
  id="skills"
  className="relative flex flex-col items-center justify-center px-6 py-12 overflow-hidden text-white"
>
  {/* Fondo nebuloso */}
  <div className="absolute inset-0 -z-20">
    ...
    <div className="flex animate-marquee space-x-12 max-w-6xl mx-auto">
      {skillIcons.concat(skillIcons).map((skill, index) => (
        <div key={index} className="relative flex flex-col items-center group">
          <span className="absolute -top-6 text-sm font-semibold opacity-0 group-hover:opacity-100 transition-all text-white">{skill.name}</span>
          <img src={skill.icon} alt={skill.name} className="h-28 w-28 object-contain group-hover:-translate-y-4 transition-transform duration-300" />
        </div>
      ))}
    </div>
  </div>
...
{/* Projects Section */}
<section id="projects" className="bg-black py-16 px-6 text-gray-100">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-3xl font-bold text-center mb-12">Projects 🚀</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
      {/* ...aquí van tus cards de proyectos como antes... */}
    </div>
  </div>
</section>
...
<section id="education" className="py-16 px-6">
  ...
  <div className="flex flex-col items-center gap-8">
    <motion.div className="flex flex-col md:flex-row items-center gap-6 bg-black rounded-2xl p-8 shadow-lg w-full max-w-4xl"
