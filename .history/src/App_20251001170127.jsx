...
<div className="relative w-full py-16 z-10 bg-black/10 overflow-hidden">
  <div className="flex space-x-16 justify-center animate-marquee">
    {skillIcons.concat(skillIcons).map((skill, index) => (
      <div key={index} className="relative flex flex-col items-center group">
        {/* Tooltip */}
        <span
          className="absolute -top-12 px-3 py-1 rounded text-lg font-bold text-cyan-400 opacity-0 group-hover:opacity-100 select-none"
          style={{
        ...
        <img
          src={skill.icon}
          alt={skill.name}
          className="h-40 w-40 md:h-48 md:w-48 object-contain transition-transform duration-300 group-hover:-translate-y-6"
        />
      </div>
    ))}
  </div>
