...
<section className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
  ...
  <div className="absolute inset-0 -z-20">
    ...
    <div className="absolute w-[220%] h-[220%] rounded-full blur-[400px] animate-nebulaMove" style={{
      background: 'radial-gradient(circle at 30% 40%, #2a0a45, #4b0082, transparent 70%)',
      opacity: 0.8,
      mixBlendMode: 'screen'
    }} />
    {/* Rosa brillante */}
    <div className="absolute w-[200%] h-[200%] rounded-full blur-[350px] animate-nebulaMove2" style={{
      background: 'radial-gradient(circle at 70% 50%, #ff2e92, #ff69b4, transparent 65%)',
      opacity: 0.6,
      mixBlendMode: 'screen'
    }} />
    {/* Azul turquesa */}
    <div className="absolute w-[240%] h-[240%] rounded-full blur-[320px] animate-nebulaMove3" style={{
      background: 'radial-gradient(circle at 50% 70%, #00c9ff, #0066ff, transparent 70%)',
      opacity: 0.7,
      mixBlendMode: 'screen'
    }} />
    {/* Toque extra de púrpura rosado */}
    <div className="absolute w-[250%] h-[250%] rounded-full blur-[300px] animate-nebulaMove2" style={{
      background: 'radial-gradient(circle at 40% 60%, #d946ef, #a855f7, transparent 70%)',
      opacity: 0.5,
      mixBlendMode: 'screen'
    }} />
  </div>
  ...
  {[...Array(800)].map((_, i) => {
    ...
    const color = ["#ffffff","#c0c0ff","#ffa0ff","#a0ffff","#ffd700"][Math.floor(Math.random()*5)];
    return (
      <motion.span
        key={i}
  ...
  <h1 className="relative text-5xl md:text-7xl lg:text-8xl font-extrabold uppercase tracking-wide text-center select-none z-20">
    Hi, I'm{" "}
    <span>
