...
<section
  id="about"
  className="relative min-h-screen flex items-center justify-center px-6 py-12 overflow-hidden text-white"
>
  {/* Fondo nebuloso */}
...
<section
  id="concept"
  className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12 overflow-hidden text-white"
>
...
>
  ...
  <div className="relative max-w-6xl w-full flex flex-col items-center gap-12 z-10">
    <h2 className="text-4xl font-bold text-white mb-10 text-center">Education</h2>

<motion.div 
  className="flex flex-col md:flex-row items-center justify-center text-center gap-6 bg-black rounded-2xl p-8 shadow-lg w-full"
