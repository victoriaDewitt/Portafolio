...
<section id="about" className="relative min-h-screen flex items-center justify-center bg-black/90 text-white px-6 py-16">
  <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="flex justify-center">
      <img 
        src="/images/vicky.jpg"   // 👈 cambia la ruta por la tuya
