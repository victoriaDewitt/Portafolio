...
{/* Banda de Skills */}
<div className="relative w-full overflow-hidden py-12 z-10"> {/* más padding para centrar */}
  <div className="flex animate-marquee space-x-16 max-w-6xl mx-auto">
    {skillIcons.concat(skillIcons).map((skill, index) => (
      ...
      >
        {/* Tooltip estilo neón */}
        <motion.span
          className="absolute bottom-full mb-3 px-3 py-1 rounded text-sm font-semibold text-cyan-400 opacity-0 select-none"
          style={{
