  ...
  return (
    <div className="font-sans bg-white text-gray-900 dark:bg-black dark:text-gray-100">
      ...
      <section
        ...
        bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400 text-white
        dark:from-blue-600 dark:via-purple-800 dark:to-black"
      >
        <motion.h2
        ...
        <a
          href="#projects"
          className="mt-8 px-6 py-3 bg-white text-indigo-600 font-semibold rounded-2xl shadow-lg hover:bg-gray-100 transition dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
        >
          See My Work
        </a>
      </section>
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            ...
            <div className="flex items-center 
              ...
              <div className="w-1/3 flex justify-center items-center">
                <div className="w-20 h-20 bg-indigo-500 rounded-xl"></div>
              </div>
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 mb-1">01</div>
                  <h3 className="text-xl font-bold mb-1">Project 1</h3>
                  <p className="text-gray-700 dark:text-gray-200 text-sm">React + Tailwind</p>
                </div>
            ...
            <div className="flex items-center 
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 mb-1">02</div>
                  <h3 className="text-xl font-bold mb-1">Project 2</h3>
                  <p className="text-gray-700 dark:text-gray-200 text-sm">Java + MySQL</p>
                </div>
                <button className="mt-2 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">
                  Explore
                </button>
            ...
            <div className="flex items-center 
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 mb-1">03</div>
                  <h3 className="text-xl font-bold mb-1">Project 3</h3>
                  <p className="text-gray-700 dark:text-gray-200 text-sm">Dashboard + Animations</p>
                </div>
                <button className="mt-2 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">
                  Explore
                </button>
      ...
      <section id="skills" className="max-w-5xl mx-auto py-20 px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 text-center">
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-xl shadow">⚛️ React</div>
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-xl shadow">🎨 Tailwind</div>
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-xl shadow">☕ Java</div>
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-xl shadow">🐬 MySQL</div>
        </div>
      </section>
      ...
      <section
        id="contact"
        className="bg-gradient-to-r from-indigo-300 to-purple-400 text-gray-900 
        dark:from-blue-700 dark:to-purple-900 dark:text-white py-20 px-6"
      >
