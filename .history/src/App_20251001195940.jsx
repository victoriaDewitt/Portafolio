...
<section className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
  ...
  {/* Fondo oscuro */}
  <div className="absolute inset-0 bg-black z-0" style={{ opacity: 0.85 }}></div>
  ...
  {/* Nombre */}
  <h1 className="relative z-10 text-5xl md:text-7xl lg:text-8xl font-extrabold uppercase tracking-wide text-center select-none">
    Hi, I'm{" "}
    <span>
  ...
  <div className="mt-8 flex justify-center relative z-10">
    <a 
      href="/VictoriaCV.pdf" 
      download
      className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg transition-all pointer-events-auto"
    >
      ...
      <section id="concept" className="relative flex flex-col items-center justify-center px-6 py-12 overflow-hidden text-white">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-indigo-400 mb-8">My concept💡</h2>
      ...
      <section id="projects" className="relative flex flex-col items-center justify-center px-6 py-16 overflow-hidden text-white">
        ...
        <div className="relative max-w-6xl w-full mt-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-indigo-400 mb-8">Projects 🚀</h2>
