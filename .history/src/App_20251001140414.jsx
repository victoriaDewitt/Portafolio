...
<section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden bg-black">
  ...
  <div className="absolute inset-0 -z-10">
    <div className="absolute w-[200%] h-[200%] bg-purple-700/40 rounded-full blur-[300px] animate-nebulaMove"></div>
    <div className="absolute w-[180%] h-[180%] bg-pink-600/30 rounded-full blur-[250px] animate-nebulaMove2"></div>
    <div className="absolute w-[220%] h-[220%] bg-blue-800/20 rounded-full blur-[280px] animate-nebulaMove3"></div>
  </div>
  ...
  {[...Array(80)].map((_, i) => {
    ...
    return (
      <motion.span
        ...
        style={{ width: size, height: size, left: `${left}%`, top: `${top}%`, opacity: 0.8 }}
