...
<div className="relative w-full overflow-hidden py-12 z-10">
  <div className="flex animate-marquee space-x-16 max-w-6xl mx-auto">
    {skillIcons.concat(skillIcons).map((skill, index) => (
      <div key={index} className="relative flex flex-col items-center group">
        {/* Tooltip */}
        <span
          className="absolute -top-8 px-3 py-1 rounded text-sm font-semibold text-cyan-400 opacity-0 group-hover:opacity-100 select-none"
          style={{
