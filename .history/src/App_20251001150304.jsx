...
<section className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <div className="absolute w-[220%] h-[220%] rounded-full blur-[350px] animate-nebulaMove" style={{
      background: 'radial-gradient(circle at 30% 40%, #4b0082, transparent 70%)',
      opacity: 0.65,
      mixBlendMode: 'screen'
    }} />
    {/* Fucsia profundo */}
    <div className="absolute w-[200%] h-[200%] rounded-full blur-[300px] animate-nebulaMove2" style={{
      background: 'radial-gradient(circle at 70% 50%, #8b006b, transparent 65%)',
      opacity: 0.6,
      mixBlendMode: 'screen'
    }} />
    {/* Azul petróleo */}
    <div className="absolute w-[240%] h-[240%] rounded-full blur-[280px] animate-nebulaMove3" style={{
      background: 'radial-gradient(circle at 50% 70%, #004466, transparent 70%)',
      opacity: 0.55,
      mixBlendMode: 'screen'
    }} />
  </div>
