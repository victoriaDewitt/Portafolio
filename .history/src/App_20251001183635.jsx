...
function App() {
  ...
  return (
    <div className="font-sans bg-black text-gray-100 relative">
      ...
      <section id="about" className="relative flex items-center justify-center px-6 py-12 overflow-hidden text-white">
        ...
        <div className="relative max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center z-10">
          ...
          <motion.div initial={{ scale: 0.95 }} whileHover={{ scale: 1.05 }} transition={{ duration: 0.5 }} className="flex justify-center">
            <img src="/images/vicky.jpg" alt="Victoria Vázquez" className="rounded-full shadow-lg w-48 h-48 md:w-64 md:h-64 object-cover border-4 border-white/20"/>
          </motion.div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-gradient-to-r from-blue-800 to-purple-900 text-white py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Contact Me</h2>
          <p className="mb-6">Let’s build something amazing together.</p>
          <a href="mailto:vazquez-gtz@hotmail.com" className="px-6 py-3 bg-gray-800 text-indigo-400 font-semibold rounded-2xl shadow-lg hover:bg-gray-700 transition">
            Send Email
          </a>
        </div>
      </section>
