...
function App() {
  ...
  <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold uppercase text-center select-none">
    Hi, I&apos;m
  </h1>

  <motion.h1
    className="relative mt-4 text-7xl md:text-9xl font-extrabold uppercase tracking-wide cursor-pointer"
    whileHover="hover"
  >
    ...
    {/* Neon glow */}
    <span className="absolute inset-0 text-transparent text-neon pointer-events-none">
      Victoria
    </span>
  </motion.h1>
