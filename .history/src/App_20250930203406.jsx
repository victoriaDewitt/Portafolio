      ...
      <section id="projects" className="bg-black py-20 px-6 text-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            {/* Project 1 */}
            <div className="flex items-center bg-gradient-to-r from-indigo-500 to-indigo-700 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
                <div className="w-20 h-20 bg-indigo-400 rounded-xl"></div>
              </div>
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  <h3 className="text-xl font-bold mb-1">eccomerce-tcg Store</h3>
                  <div className="text-sm text-gray-200 mb-1">Java+springboot+html</div>
                  <p className="text-gray-200 text-sm">Hoenn TCG Store is an interactive e-commerce platform where users can browse, filter, and purchase Pokémon Trading Card Game products. It features a dynamic shopping cart, user authentication, and product management by category and expansion. Ideal for demonstrating full-stack development skills with Java and frontend technologies.
            ...
            {/* Project 2 */}
            <div className="flex items-center bg-gradient-to-r from-pink-500 to-pink-700 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold mb-1"> Amazon Product Availability Bot
</h3>
                   <div className="text-sm text-gray-200 mb-1">Python</div>
                  <p className="text-gray-200 text-sm">This project is a Python bot that sends an email alert when a product becomes available on Amazon Mexico.
It's ideal for automating product monitoring and receiving real-time notifications about restocks.</p>
                </div>
                <button className="mt-2 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">Explore</button>
              </div>
            </div>
            {/* Project 3 */}
            <div className="flex items-center bg-gradient-to-r from-green-400 to-green-600 rounded-2xl shadow-xl w-[350px] h-[220px] p-6 hover:scale-105 transition-transform">
              <div className="w-1/3 flex justify-center items-center">
                <div className="w-20 h-20 bg-green-300 rounded-xl"></div>
              </div>
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                <div>
                  <h3 className="text-xl font-bold mb-1">Streamline</h3>
                  <div className="text-sm text-gray-200 mb-1">Messaging and task management app with FlutterFlow and Firebase</div>
                  <p className="text-gray-200 text-sm">Flutterflow + Firebase</p>
                </div>
                <button className="mt-2 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">Explore</button>
              </div>
            </div>
...
<div className="mt-16 overflow-hidden relative w-full">
  <div className="flex animate-marquee gap-16 whitespace-nowrap justify-center">
    {skillIcons.concat(skillIcons).map((skill, idx) => (
      <div key={idx} className="inline-block relative group">
        ...
        />
        <span className="absolute bottom-full mb-2 px-2 py-1 text-sm rounded bg-black text-white opacity-0 group-hover:opacity-100 transition">
          {skill.name}
        </span>
      </div>
    ))}
