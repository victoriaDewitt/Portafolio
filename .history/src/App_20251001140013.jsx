...
<section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden bg-black">
  {/* Nebulosa generada con CSS */}
  <div className="absolute inset-0 -z-10">
    <div className="w-full h-full bg-gradient-radial from-purple-800/40 via-pink-700/30 to-blue-900/20 animate-nebulaMove blur-3xl"></div>
    <div className="w-full h-full bg-gradient-radial from-indigo-900/30 via-cyan-800/20 to-black/0 animate-nebulaMove2 blur-2xl"></div>
  </div>
  ...
  <style jsx>{`
    ...
    /* Animación inicial de la nebulosa */
    ...
    .animate-nebulaMove2 {
      animation: nebulaMove2 25s ease-in-out infinite alternate;
    }
  `}</style>
</section>
