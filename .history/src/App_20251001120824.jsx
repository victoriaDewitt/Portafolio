...
.text-neon {
  ...
  text-shadow:
    ...
    0 0 10px #0ff,
    0 0 20px #0ff;
  opacity: 0; /* inicio apagado */
}

/* Animación tipo "encendido neón" */
@keyframes startup {
  0%, 10% { opacity: 0; text-shadow: none; }
  20%, 30% { opacity: 0.4; text-shadow: 0 0 2px #0ff; }
  40%, 50% { opacity: 1; text-shadow: 0 0 5px #0ff, 0 0 10px #0ff; }
  100% { opacity: 1; text-shadow: 0 0 2px #0ff, 0 0 5px #0ff, 0 0 10px #0ff, 0 0 20px #0ff; }
}

.startup {
  animation: startup 2s forwards; /* duración de la animación y se queda en el estado final */
}
