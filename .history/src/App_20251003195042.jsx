...
>
  ...
  <div className="flex flex-col items-center md:items-start">
    ...
    <a
      ...
      className="mt-3 inline-block px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-lg font-semibold transition-transform transform hover:scale-105"
    >
      🎓 Ver Título Digital
    </a>
  </div>
