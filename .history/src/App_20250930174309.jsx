...
<div
  id="cursorSphere"
  className="w-20 h-20 rounded-full fixed pointer-events-none z-50 bg-indigo-500/20 blur-3xl transform -translate-x-1/2 -translate-y-1/2 transition-all duration-150"
></div>
