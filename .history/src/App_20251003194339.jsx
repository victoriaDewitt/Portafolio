...
<h1 className="relative z-20 text-7xl md:text-9xl lg:text-[10rem] font-extrabold uppercase tracking-wide text-center select-none">
 <span className="font-medium text-white/70">Hi, I'm{" "}</span>
...
<div className="bg-gradient-to-r from-green-500 to-green-700 rounded-2xl shadow-xl w-[380px] hover:scale-105 transition-transform overflow-hidden">
  ...
  <div className="p-4 flex flex-col justify-between">
    <div>
      <h3 className="text-2xl font-quantico font-bold mb-2">Eccomerce-tcg Store</h3>
...
<div className="bg-gradient-to-r from-pink-700 to-pink-900 rounded-2xl shadow-xl w-[380px] hover:scale-105 transition-transform overflow-hidden">
  ...
  <div className="p-4 flex flex-col justify-between">
    <div>
      <h3 className="text-2xl font-quantico font-bold mb-2">Amazon Product Availability Bot</h3>
...
<div className="bg-gradient-to-r from-indigo-700 to-indigo-900 rounded-2xl shadow-xl w-[380px] hover:scale-105 transition-transform overflow-hidden">
  ...
  <div className="p-4 flex flex-col justify-between">
    <div>
      <h3 className="text-2xl font-quantico font-bold mb-2">Streamline</h3>
  ...
  >
    🎓
        ...
        <motion.div 
  className="flex flex-col md:flex-row items-center justify-center text-center gap-6 bg-black rounded-2xl p-6 shadow-lg w-full"
...
>
  ...
  <div className="flex flex-col items-center md:items-start">
    ...
    {/* Diploma como tarjeta clickeable */}
    <a 
      href="/TituloVictoria.pdf"   // aquí va tu PDF limpio de 1 página
      target="_blank" 
      rel="noopener noreferrer"
      className="mt-5 block transform hover:scale-105 transition duration-300"
    >
      <img 
        src="/titulo-victoria.png"  // aquí va la imagen de tu diploma recortado
        alt="Título Digital - Victoria Vázquez" 
        className="rounded-2xl shadow-2xl border border-gray-700 w-80 md:w-[500px]"
      />
    </a>
  </div>
</motion.div>
...
<section id="contact" className="relative text-white py-20 px-6">
  ...
  <div className="absolute inset-0 bg-gradient-to-r from-blue-900 via-indigo-800 to-cyan-900
