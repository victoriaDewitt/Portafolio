...
>
  ...
  efficient solutions and am always eager to learn new technologies and improve my skills.
      ...
      My Concept
        ...
        <div className="relative max-w-5xl w-full bg-gradient-to-r from-indigo-600 via-purple-700 to-pink-600/80 rounded-2xl p-8 shadow-lg flex flex-col md:flex-row justify-center items-center gap-12 z-10">
