...
<section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden bg-black">
  ...
  {/* Nebulosa con divs y gradientes */}
  <div className="absolute inset-0 -z-10">
    <div className="absolute w-[200%] h-[200%] bg-gradient-to-r from-purple-600/60 via-pink-500/50 to-blue-700/50 rounded-full blur-[300px] animate-nebulaMove"></div>
    <div className="absolute w-[180%] h-[180%] bg-gradient-to-r from-pink-500/40 via-purple-400/40 to-indigo-600/40 rounded-full blur-[250px] animate-nebulaMove2"></div>
    <div className="absolute w-[220%] h-[220%] bg-gradient-to-r from-cyan-400/30 via-blue-500/30 to-purple-500/30 rounded-full blur-[280px] animate-nebulaMove3"></div>
  </div>
  ...
  {[...Array(80)].map((_, i) => {
    ...
    const color = ["#fff","#ffe","#aff","#faf"][Math.floor(Math.random()*4)];
    return (
      <motion.span
        key={i}
        className="absolute rounded-full"
        style={{ width: size, height: size, left: `${left}%`, top: `${top}%`, backgroundColor: color, opacity: 0.7 }}
  ...
  {/* Nombre con efecto de encendido */}
  <h1
  ...
  <style jsx>{`
    ...
    .animate-nebulaMove2 {
      animation: nebulaMove2 50s ease-in-out infinite alternate;
    }

    .animate-nebulaMove3 {
      animation: nebulaMove3 60s ease-in-out infinite alternate;
    }
  `}</style>
</section>
