...
<section id="projects" className="bg-black py-20 px-6 text-gray-100">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="flex flex-wrap gap-8 justify-center">
      ...
      {/* Project 1 */}
      <div className="flex items-center bg-gradient-to-r from-indigo-500 to-indigo-700 rounded-2xl shadow-xl w-[380px] p-6 hover:scale-105 transition-transform">
        {/* Imagen */}
        <div className="w-1/3 flex justify-center items-center">
          <img
            src="/images/ecommerce.png" // 🔄 cámbialo por tu imagen real
        ...
        <div className="w-2/3 pl-4 flex flex-col justify-between">
          <div>
            ...
            <div className="text-sm text-gray-200 mb-1">Java + Spring Boot + HTML</div>
            <p className="text-gray-200 text-sm">
              Hoenn TCG Store is an interactive e-commerce platform where users can
              browse, filter, and purchase Pokémon Trading Card Game products. It
              features a dynamic shopping cart, user authentication, and product
              management by category and expansion.
            </p>
          </div>
          <button className="mt-3 self-start bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg font-semibold">
            Explore
          </button>
        </div>
      </div>
      ...
      {/* Project 2 */}
      <div className="flex items-center bg-gradient-to-r from-pink-500 to-pink-700 rounded-2xl shadow-xl w-[380px] p-6 hover:scale-105 transition-transform">
        {/* Imagen */}
        <div className="w-1/3 flex justify-center items-center">
          <img
            src="/images/bot.png" // 🔄 cámbialo por tu imagen real
        ...
        <div className="w-2/3 pl-4 flex flex-col justify-between">
          <div>
            <h3 className="text-xl font-bold mb-1">Amazon Product Availability Bot</h3>
            <div className="text-sm text-gray-200 mb-1">Python</div>
            <p className="text-gray-200 text-sm">
              Python bot that sends an email alert when a product becomes available
              on Amazon Mexico. Ideal for automating product monitoring and receiving
      ...
      {/* Project 3 */}
      <div className="flex items-center bg-gradient-to-r from-green-400 to-green-600 rounded-2xl shadow-xl w-[380px] p-6 hover:scale-105 transition-transform">
        {/* Imagen */}
        <div className="w-1/3 flex justify-center items-center">
          <img
            src="/images/streamline.png" // 🔄 cámbialo por tu imagen real
            alt="Streamline App"
            className="w-24 h-24 object-cover rounded-xl shadow-md"
          />
        </div>
