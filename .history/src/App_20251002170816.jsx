...
<div className="mt-8 flex justify-center relative z-20">
  <a 
    href="/VictoriaCV.pdf" 
    download
    className="flex items-center gap-2 bg-[#14b8a6] text-white font-semibold px-6 py-3 rounded-xl shadow-lg 
               hover:bg-[#0f766e] hover:shadow-[0_0_15px_#14b8a6] transform hover:scale-105 
