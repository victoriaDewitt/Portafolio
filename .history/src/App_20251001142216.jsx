...
function App() {
  ...
  return (
    <div className="font-sans bg-black text-gray-100 relative">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center text-white overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute w-[220%] h-[220%] rounded-full blur-[350px] animate-nebulaMove" style={{
            background: 'radial-gradient(circle at 30% 40%, #9b5de5, transparent 70%)',
            opacity: 0.7,
            mixBlendMode: 'screen'
          }}></div>
          <div className="absolute w-[200%] h-[200%] rounded-full blur-[300px] animate-nebulaMove2" style={{
            background: 'radial-gradient(circle at 70% 50%, #f15bb5, transparent 60%)',
            opacity: 0.6,
            mixBlendMode: 'screen'
          }}></div>
          <div className="absolute w-[240%] h-[240%] rounded-full blur-[280px] animate-nebulaMove3" style={{
            background: 'radial-gradient(circle at 50% 70%, #00bbf9, transparent 70%)',
            opacity: 0.5,
            mixBlendMode: 'screen'
          }}></div>
        </div>
        ...
        {/* CSS interno para letras y animaciones de nebulosa */}
        <style jsx>{`
          .text-neon {
            color: #0ff;
      ...
      {/* Aquí sigue todo tu código original de About, Concept, Projects, Skills, Education, Contact y Footer */}
