...
<section className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
  ...
  <div className="absolute inset-0 -z-20">
    <div className="absolute w-[220%] h-[220%] rounded-full blur-[400px] animate-nebulaMove" style={{
      background: 'radial-gradient(circle at 30% 40%, #1a1b33, #4b0082, transparent 70%)',
      opacity: 0.7,
      mixBlendMode: 'screen'
    }} />
    <div className="absolute w-[200%] h-[200%] rounded-full blur-[350px] animate-nebulaMove2" style={{
      background: 'radial-gradient(circle at 70% 50%, #ff69b4, #8a2be2, transparent 60%)',
      opacity: 0.6,
      mixBlendMode: 'screen'
    }} />
    <div className="absolute w-[240%] h-[240%] rounded-full blur-[300px] animate-nebulaMove3" style={{
      background: 'radial-gradient(circle at 50% 70%, #00bfff, #4b0082, transparent 70%)',
      opacity: 0.5,
      mixBlendMode: 'screen'
    }} />
  </div>
  ...
  {/* Estrellas */}
  {[...Array(800)].map((_, i) => { // ¡muchas estrellas!
    const size = Math.random() * 2.5 + 0.5; // más variedad en tamaño
